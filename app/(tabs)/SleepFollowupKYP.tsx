    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.question}>Is it hard for you to relax before sleep?</Text>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.question}>Do you wake up hot and sweaty at night?</Text>
          <View style={styles.optionRow}>
            <TouchableOpacity
              style={styles.optionButton}
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.question}>Do you struggle to wake up early?</Text>
          <View style={styles.optionRow}>
            <TouchableOpacity
              style={styles.optionButton}
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('SleepKYP')}>
            <Text style={styles.backButtonText}>Back</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('StressKYP')}>
